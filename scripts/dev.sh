...
STAGE_SA_ACCOUNT=tfstagebackend2025veni
DEV_SA_ACCOUNT=tfdevbackend2025veni
...
az storage account create --resource-group $RESOURCE_GROUP_NAME --name $STAGE_SA_ACCOUNT --location centralindia --sku Standard_LRS --encryption-services blob 

# Create storage account for dev environment
az storage account create --resource-group $RESOURCE_GROUP_NAME --name $DEV_SA_ACCOUNT --location centralindia --sku Standard_LRS --encryption-services blob 
